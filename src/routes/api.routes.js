...
const { handleAlbumById, handleArtistById, handleArtistDiscover, handleArtistLookup, handleRecentFeed, handleSearch, handleSongAlbums } = require('../controllers/proxy.controller')
