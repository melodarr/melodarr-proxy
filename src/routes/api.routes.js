...
const { handleAlbumById, handleArtistById, handleArtistDiscover, handleArtistLookup, handleRecentFeed, handleReleaseSearch, handleSearch, handleSongAlbums } = require('../controllers/proxy.controller')
